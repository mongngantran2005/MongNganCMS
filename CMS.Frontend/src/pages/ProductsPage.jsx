      ...
      <div className="container" style={{ display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          {!loading && processed.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '60px 20px', backgroundColor: '#fff', borderRadius: '8px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
              <h3 style={{ fontSize: '18px', color: '#666', fontWeight: '500' }}>Rất tiếc, chúng tôi chưa có sản phẩm nào cho danh mục này.</h3>
              <p style={{ color: '#999', marginTop: '10px' }}>Vui lòng thử lại với từ khóa khác hoặc bỏ bớt các bộ lọc.</p>
            </div>
          ) : (
            <>
